...
# (default) prompt is the canonical baseline; the en path only appends this
# directive. The whole prompt is written in Spanish, which implicitly yields
# Spanish output.
...
def _build_system_prompt(lang: str = "es") -> str:
    base = dedent("""\
        Eres un asistente clínico otoneurológico (Clinibrium). Tu función es EXPLICAR
